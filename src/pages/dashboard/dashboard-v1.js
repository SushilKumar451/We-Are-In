          ...
          <div className='col-xl-8'>
            ...
            >
              <NavItem>
                ...
                >
                  <i className='fa fa-camera fa-lg m-r-5'></i>{' '}
              ...
              <NavItem>
                ...
                >
                  <i className='fa fa-archive fa-lg m-r-5'></i>{' '}
                  ...
                  <ul className='media-list media-list-with-divider'>
                    <li className='media media-lg'>
                      ...
                      <div className='media-body'>
                        ...
                        lacinia vel. Nullam tristique lobortis mauris, ultricies
                        fermentum lacus bibendum id. Proin non ante tortor.
                        Suspendisse pulvinar ornare tellus nec pulvinar. Nam
                        pellentesque accumsan mi, non pellentesque sem convallis
                    ...
                    <li className='media media-lg'>
                      ...
                      <div className='media-body'>
                        ...
                        nisi a, facilisis eleifend nulla. Praesent aliquet odio
                        non imperdiet fringilla. Morbi a porta nunc. Vestibulum
                    ...
                    <li className='media media-lg'>
                      ...
                      <div className='media-body'>
                        ...
                        cursus magna, tincidunt sodales ipsum lobortis
                        tincidunt. Mauris quis lorem ligula. Morbi placerat est
                        nec pharetra placerat. Ut laoreet nunc accumsan orci
                        aliquam accumsan. Maecenas volutpat dolor vitae sapien
                        ultricies fringilla. Suspendisse vitae orci sed nibh
                        ultrices tristique. Aenean in ante eget urna semper
                        imperdiet. Pellentesque sagittis a nulla at scelerisque.
                      </div>
                    </li>
                  </ul>
                </PerfectScrollbar>
                  ...
                  <table className='table'>
                    ...
                    <tbody>
                      <tr>
                        ...
                        <td>$349.00</td>
                        <td className='text-nowrap'>
                          <Link to='/dashboard/v1'>Derick Wong</Link>
                        </td>
                      </tr>
                      <tr>
                        <td>13/02/2013</td>
                  ...
                  <ul className='media-list media-list-with-divider'>
                    ...
                    <li className='media media-sm'>
                      ...
                      <div className='media-body'>
                        <Link to='/dashboard/v1'>
                          <h4 className='media-heading'>
                            Praesent et sem porta leo tempus tincidunt eleifend
                            et arcu.
                          </h4>
                        </Link>
                        <p className='m-b-5'>
                    ...
                    <li className='media media-sm'>
                      ...
                      <div className='media-body'>
                        ...
                        <p className='m-b-5'>
                          ...
                          vel magna enim. Aenean volutpat a dui vitae pulvinar.
                          Nullam ligula mauris, dictum eu ullamcorper quis,
                          lacinia nec mauris.
                        </p>
                        <i className='text-muted'>
                          Received on 04/16/2013, 12.39pm
