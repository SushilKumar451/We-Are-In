            ...
            <Panel>
              ...
              <table className='table'>
                ...
                <tbody>
                  <tr>
                    <td>
                      <b className='text-inverse'>Bottom Left</b> Success
                      Notification
                    </td>
                    <td>
                      <button
                  ...
                  <tr>
                    <td>
                      <b className='text-inverse'>Bottom Right</b> Default
                      Notification
                    </td>
                    <td>
                      <button
                  ...
                  <tr>
                    <td>
                      <b className='text-inverse'>Bottom Center</b> Info
                      Notification
                    </td>
                    <td>
                      <button
                  ...
                  <tr>
                    <td>
                      <b className='text-inverse'>Top Left</b> Success
                      Notification
                    </td>
                    <td>
                      <button
                  ...
                  <tr>
                    <td>
                      <b className='text-inverse'>Top Right</b> Warning
                      Notification
                    </td>
                    <td>
                      <button
                  ...
                  <tr>
                    <td>
                      <b className='text-inverse'>Top Center</b> Custom
                      Notification
                    </td>
                    <td>
                      <button
          ...
          <div className='col-xl-6'>
            <Panel>
              ...
              <table className='table'>
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td>
                      <button
                        onClick={() => this.toggleModal('modalMessage')}
                        className='btn btn-sm btn-primary'
                      >
                        Demo
                      </button>
              ...
              <Modal
                ...
                toggle={() => this.toggleModal('modalMessage')}
                modalClassName='modal-message'
              >
                <ModalHeader toggle={() => this.toggleModal('modalMessage')}>
            ...
            <Panel title='Modal'>
              ...
              <PanelBody>
                <p className='lead m-b-10 text-inverse'>
                  SweetAlert for Bootstrap. A beautiful replacement for
                  JavaScript's "alert"
                </p>
                <hr />
                <p className=''>Try any of those!</p>
                <button
                  onClick={() => this.toggleSweetAlert('primary')}
                ...
                <button
                  onClick={() => this.toggleSweetAlert('success')}
                  className='btn btn-success m-r-5'
                >
                  Success
                </button>
                <button
                  onClick={() => this.toggleSweetAlert('warning')}
                  className='btn btn-warning m-r-5'
                >
                  Warning
                </button>
                <button
                  onClick={() => this.toggleSweetAlert('error')}
