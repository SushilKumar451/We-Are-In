...
class App extends React.Component {
  constructor(props) {
    super(props);
    if (!this.props.currentUser) this.props.loginWithJwt();
  ...
  render() {
    return (
      <PageSettings.Provider value={this.state}>
        ...
        >
          {this.props.currentUser && this.state.pageHeader && <Header />}
          {this.props.currentUser && this.state.pageSidebar && <Sidebar />}
          {this.props.currentUser && this.state.pageTwoSidebar && (
            <SidebarRight />
          )}
          {this.props.currentUser && this.state.pageTopMenu && <TopMenu />}
          {this.props.currentUser && this.state.pageContent && <Content />}
          {this.props.currentUser && this.state.pageFooter && <Footer />}
          {!this.props.currentUser && <LoginV2 />}
          <FloatSubMenu />
        </div>
...
const mapDispatchToProps = (dispatch) => ({
  loginWithJwt: () => dispatch(auth.loginWithJwt()),
});
