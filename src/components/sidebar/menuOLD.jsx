const Menu = [
  {
    ...
    title: 'Dashboard',
    children: [
      { path: '/dashboard/v1', title: 'chotix' },
  ...
  },
  {
    ...
    children: [
      ...
      { path: '/voucher/list', title: 'View Vouchers' },
  ...
  },
  {
    ...
    children: [
      { path: '/customer/overview', title: 'Overview' },
      { path: '/customer/list', title: 'View Consumers' },
      { path: '/customer/create', title: 'Create New Consumer' },
    ],
  },
  {
    path: '/form',
    ...
    children: [
      ...
      { path: '/loyalty/list', title: 'View Programmes' },
    ],
  },
  {
    path: '/email',
