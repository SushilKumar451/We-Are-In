...
import VoucherOverview from './../pages/voucher/overview';
...
import DetailBrand from './../pages/brands/detail';

import MerchantOverview from '../pages/merchants/overview';
import CreateMerchant from './../pages/merchants/create';
import MerchantList from './../pages/merchants/list';
import DetailMerchant from './../pages/merchants/detail';

import LoyaltyOverview from './../pages/loyalty/overview';
import LoyaltyList from './../pages/loyalty/list';
import CreateLoyalty from './../pages/loyalty/create';
import LoyaltyDetail from './../pages/loyalty/detail';

import VoucherRedemptionOverview from './../pages/voucherRedemption/overview';
import VoucherRedemptionList from './../pages/voucherRedemption/list';
import VoucherRedemptionDetail from './../pages/voucherRedemption/detail';
...
import Example from './../components/notification/notification';

import SetupWizard from './../pages/admin/systemsetup/setupwizard';

import CreateUser from './../pages/admin/users/create';
import UserList from './../pages/admin/users/list';

import CategoryList from '../pages/admin/list/category-list';
import TypeList from '../pages/admin/list/type-list';
import CountyList from '../pages/admin/county/list';
import CurrencyList from '../pages/admin/currency/list';
import PermissionList from '../pages/admin/permission/list';
import ActivityLogList from '../pages/admin/activityLogs/list';
...
const routes = [
  ...
  {
    path: '/voucher-redemption/overview',
    title: 'VoucherRedemption Overview',
    component: () => <VoucherRedemptionOverview />,
  },
  {
    path: '/voucher-redemption/list',
    title: 'VoucherRedemption List',
    component: () => <VoucherRedemptionList />,
  },
  {
    path: '/voucher-redemption/detail/:id',
    title: 'Voucher Redemption detail',
    component: () => <VoucherRedemptionDetail />,
  },
  {
  ...
  {
    path: '/admin/list/types',
    title: 'Type List',
    component: () => <TypeList />,
  },
  {
    path: '/admin/county/list',
    title: 'County List',
